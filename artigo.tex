...
\lstdefinelanguage{groovy}{morekeywords={abstract, default, if, private, this, boolean, do, implements, protected, throw, break,
                                         double, import, public, throws, byte, else, instanceof, return, transient, case, extends,
                                         int, short, try, catch, final, interface, static, void, char, finally, long, strictfp,
                                         volatile, class, float, native, super, while, const, for, new, switch, continue, goto,
                                         package, synchronized, def, any, as, in, with, null, true, false, static},
...
% incluir:
%    shell/console + definição de funções,
%    Strings: multiline, interpolation
%    métodos e closures
%    básico de collections (listas e maps)
%    syntax sugar: elvis operator, spread operator, remoção de parenteses, remoção de ;

%    A listagem \ref{DescriptiveLabel} ilustra uma classe escrita em Java.
%
%   as listagens abaixo incluem os arquivos abaixo.

\lstinputlisting[columns=fullflexible,
                 captionpos=b,
                 numbers=left,
                 language=Java, 
