...
\subsubsection{Criando Domain Classes - Os Contatos da Aplicação}
    ...
    \begin{lstlisting}[language=]
           grails create-app contacts <[pacote.]NomeDaClasse>
    \end{lstlisting}
    ...
    \begin{lstlisting}[language=]
           grails create-app contacts Contact
    \end{lstlisting}
   ...
   \lstinputlisting[
                      style=Groovy,
                      caption=Teste Unitário da classe Contact.groovy,
                      label=ContactTestV1
                    ]
...
\subsubsection{Acessando a aplicação}
    ...
    \lstinputlisting[
                     style=Groovy,
                     caption=ContactController gerado pelo comando create-controller,
    ...
    \lstinputlisting[
                     style=Groovy,
                     caption=ContactController com scaffolding,
