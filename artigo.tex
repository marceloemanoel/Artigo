...
%
\lstdefinelanguage{groovy}{morekeywords={abstract, default, if, private, this,
...
\section{A linguagem Groovy} \label{sec:linguagem_groovy}
    ...
    A linguagem Groovy é relativamente nova, foi criada em  Agosto de 2003, é 4
...
\subsection{Instalação}
    ...
    \begin{itemize}
        \item groovysh %Groovy Shell
        \item groovyConsole %Groovy Console (Aplicação em Swing)
        \item groovy %Compila/Executa um arquivo groovy
...
%    syntax sugar: elvis operator, spread operator, remoção de parenteses, 
%                  remoção de ;
