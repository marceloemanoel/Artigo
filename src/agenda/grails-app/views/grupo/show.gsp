    ...
    <div class="body">
      ...
      <div class="dialog">
        <table>
          <tbody>
            <tr class="prop">
              <td valign="top" class="name"><g:message code="grupo.id.label" default="Id" /></td>
              <td valign="top" class="value">${fieldValue(bean: grupoInstance, field: "id")}</td>
            </tr>
            <tr class="prop">
              <td valign="top" class="name"><g:message code="grupo.nome.label" default="Nome" /></td>
              <td valign="top" class="value">${fieldValue(bean: grupoInstance, field: "nome")}</td>
            </tr>
            <tr class="prop">
